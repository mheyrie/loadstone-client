...
export default function SignupDelete({ onSwitchToLogin, onClose }: SignupProps) {
  ...
  return (
    <div className="w-full text-white max-w-md mx-auto p-6 rounded-lg shadow-md">
        ...
        {currentStep !== "success" && (
          <div className="flex gap-3 pt-2">
            ...
            <Button
              type="submit"
              classes={`primary-btn ${
                currentStep === "account" ? "w-full" : "flex-1"
              }`}
              content="Next"
            />
          </div>
