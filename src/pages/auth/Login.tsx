...
export default function Login({ onSwitchToSignup, onClose }: LoginProps) {
  ...
  return (
    <div className="w-full">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600 text-sm">Log in to access your account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center">
            <input type="checkbox" className="w-4 h-4 text-brand-purple border-gray-300 rounded focus:ring-brand-purple" />
