...
export default function Footer() {
  return (
    <footer className="w-screen lg:h-[797px] font-montserrat  text-white  sm:bottom-0 left-0">
      ...
      {/* Newsletter Section */}
      <div className="bg-[#9668FF]  w-full lg:h-[248px] py-10 px-4 text-white text-center">
        <div className="lg:h-[200px} max-w-[1250px] mx-auto pt-37px">
          <h2 className="text-2xl  font-semibold fw-600 text-[40px]
 mb-2">Subscribe to our Newsletter</h2>
          <p className="mb-4 text-[24px] fw-500 ">
            Subscribe to our newsletter to receive updates, exclusive offers, news, and more.
          </p>
