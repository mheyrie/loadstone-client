      ...
      >
        <div className="mx-auto grid md:grid-cols-2 grid-cols-1 mt-6 max-w-6xl gap-8 p-8 ">
          <SwiperSlide>
            <div className="flex flex-col justify-start items-start px-6 py-10 gap-4 bg-brand-white rounded-lg shadow-md">
              ...
              <p className="text-lg italic">
                "Trade Lenda has transformed the way I manage my business
                finances. The loan application process was quick and
                straightforward, allowing me to access the funds I needed to
                grow my inventory and meet customer demands."
              </p>
          ...
          <SwiperSlide>
            <div className="flex flex-col justify-start items-start px-6 py-10 gap-4 bg-brand-white rounded-lg shadow-md">
              <p className="text-lg italic">
                "As a small business owner, finding reliable financing options
                has always been a challenge. Trade Lenda provided me with a
                hassle-free solution that helped me expand my operations and
