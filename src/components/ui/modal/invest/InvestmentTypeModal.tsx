...
import { mdiChartLine,  mdiMenuDown, mdiFlowerTulipOutline } from "@mdi/js";
        ...
        <div className="grid grid-rows-1 gap-4 justify-center items-center">
          {investmentTypes.map((item) => (
            <button
              ...
              className="flex px-6 border-2  hover:border-gray-200 rounded-lg border-brand-purple hover:shadow-lg transition-all text-left group"
            >
              ...
              <Icon path={item.icon2} size={1} className="ml-auto text-green-400 group-hover:text-brand-purple transition" />
