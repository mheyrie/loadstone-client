    ...
    <Modal isOpen={isOpen} onClose={onClose} maxWidth="md" useBackgroundImage={false}>
      <div className="p-6">
        ...
        <p className="text-gray-600 mb-6">
          How much would you like to invest in the <span className="font-semibold text-brand-purple capitalize">{planTitle}</span> plan?
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-purple-50 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-gray-900">₦{maxAmount.toLocaleString()}</span>
              </div>
              <div className="border-t border-purple-200 pt-2 mt-2">
                <div className="flex justify-between">
                  <span className="text-gray-600">Available Balance:</span>
                  <span className="font-semibold text-brand-purple">₦8,500,000.00</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[minAmount, Math.floor((minAmount + maxAmount) / 2), maxAmount].map((quickAmount) => (
                <button
                  key={quickAmount}
